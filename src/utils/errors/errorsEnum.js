...
export const ErrorsMessage = {
  ...
  PRODUCT_DATA_CODE_ALREADY_EXISTS_IN_DATABASE:
    "Request failed. This product already exists in database. Please change the product code.",

  PRODUCT_DATA_NOT_ENOUGH_STOCK:
    "Request failed. This product has not enough stock.",
};
...
export const ErrorsCause = {
  ...
  PRODUCT_DATA_NOT_FOUND_IN_DATABASE:
    "Request failed. Cause: Not found in database.",
  USER_DATA_NOT_FOUND_IN_DATABASE: "Request failed. Not found in database",
  CART_DATA_NOT_FOUND_IN_DATABASE: "Request failed. Not found in database",
  ...
  PRODUCT_DATA_CODE_ALREADY_EXISTS_IN_DATABASE:
    "Request failed. Product code already exists in database.",
